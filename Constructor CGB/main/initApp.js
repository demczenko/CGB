...
const state = {
  ...
  translations: [],
  token:
    "ya29.a0Ad52N38Xtdm09_e0etaVazPTcL_KbvVNCHX2kEfhgPUvryw-Lg2UnJVMMNEhqHu81U4Pfw_TX_i5-MdGvlgzTis0OwQAmsy5P_elcj-DaQZRu-nZjlDNF6AtwR2fpH-jZXVJ0xxw5FvaPLzCqHp1Whbx0ZX9OmJZD81QaCgYKAXASARMSFQHGX2MiYNBKxTz-c1St-HNftg_fuA0171",
};
  ...
  async function getTemplate() {
    ...
    return await templates[template]({
      ...
      getCategory: (category, options) => {
        ...
        if (!options?.origin) {
          return new URL(getQueryLink(new_link)).pathname;
        }
